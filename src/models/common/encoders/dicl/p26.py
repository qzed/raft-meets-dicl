...
class FeatureEncoder(nn.Module):
    ...
    def __init__(self, output_channels, norm_type='batch'):
        super().__init__()
        ...
        self.conv6a = ConvBlock(160, 192, kernel_size=3, padding=1, stride=2, norm_type=norm_type)

        self.deconv6a = GaConv2xBlockTransposed(192, 160, norm_type=norm_type)
        ...
        self.conv6b = GaConv2xBlock(160, 192, norm_type=norm_type)

        self.deconv6b = GaConv2xBlockTransposed(192, 160, norm_type=norm_type)
        self.outconv6 = ConvBlock(160, output_channels, kernel_size=3, padding=1, norm_type=norm_type)

        self.deconv5b = GaConv2xBlockTransposed(160, 128, norm_type=norm_type)
        self.outconv5 = ConvBlock(128, output_channels, kernel_size=3, padding=1, norm_type=norm_type)

        self.deconv4b = GaConv2xBlockTransposed(128, 96, norm_type=norm_type)
        self.outconv4 = ConvBlock(96, output_channels, kernel_size=3, padding=1, norm_type=norm_type)

        self.deconv3b = GaConv2xBlockTransposed(96, 64, norm_type=norm_type)
        self.outconv3 = ConvBlock(64, output_channels, kernel_size=3, padding=1, norm_type=norm_type)

        self.deconv2b = GaConv2xBlockTransposed(64, 48, norm_type=norm_type)
        self.outconv2 = ConvBlock(48, output_channels, kernel_size=3, padding=1, norm_type=norm_type)
